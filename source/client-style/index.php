...
<script src="jquery.min.js"></script> <!-- //ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js -->
<script src="angular.min.js"></script> <!-- https://ajax.googleapis.com/ajax/libs/angularjs/1.0.8/angular.min.js -->
