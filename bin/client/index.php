...
<ul class="editul" id="editarea" unselectable="on">
 ...
 <li onmouseout="rich.unshowtitle();" onmouseover="rich.showtitle(this.offsetWidth, this.offsetLeft, 'underlined');" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" unselectable="on" onclick="rich.fontEdit('underline')"><img src="img/doc/unter.png" unselectable="on"></li>
 ...
 <li onmouseout="rich.unshowtitle(); rich.sizechangehide();" onmouseover="rich.donthide(this.id); rich.showtitle(this.offsetWidth, this.offsetLeft, 'fontsize');" id="sizechangeButton" onmouseout="rich.dohide();" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" onclick="rich.sizechange(1);"><img src="img/doc/fontsize.png"></li>
 ...
 <li onmouseout="rich.unshowtitle();" onmouseover="rich.showtitle(this.offsetWidth, this.offsetLeft, 'indent');" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" onclick="rich.fontEdit('indent');"><img src="img/doc/tab.png"></li>
 <li onmouseout="rich.unshowtitle();" onmouseover="rich.showtitle(this.offsetWidth, this.offsetLeft, 'outdent');" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" onclick="rich.fontEdit('outdent');"><img src="img/doc/untab.png"></li>
 <li onmouseout="rich.unshowtitle();" onmouseover="rich.showtitle(this.offsetWidth, this.offsetLeft, 'unordered list');" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" onclick="rich.fontEdit('insertunorderedlist');"><img src="img/doc/list.png"></li>
 <li onmouseout="rich.unshowtitle();" onmouseover="rich.showtitle(this.offsetWidth, this.offsetLeft, 'ordered list');" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" onclick="rich.fontEdit('insertorderedlist');"><img src="img/doc/numblist.png"></li>
 <li onmouseout="rich.unshowtitle();" onmouseover="rich.showtitle(this.offsetWidth, this.offsetLeft, 'insert link (out of work)');" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" onclick="rich.fontEdit('');"><img src="img/doc/addlink.png"></li>
 <li onmouseout="rich.unshowtitle();" onmouseover="rich.showtitle(this.offsetWidth, this.offsetLeft, 'insert picture (out of work)');" class="editli" style="min-width: 31px;" unselectable="on"><input class="unselectinput" type="button" onclick="rich.fontEdit('');"><img src="img/doc/addimg.png"></li>
</ul>
...
<div class="noteconBackground" id="noteconBackground">
    ...
    <div class="fileOperationsBar">
        ...
        <ul class="dirButtons">
            <li class="dirButtonsLi" style="z-index: 2;" onclick="alert('out of work');" title="delete file (out of work)"><img src="img/doc/loeschen.png" style="margin-top: -3px; opacity: 0.6; "></li>
